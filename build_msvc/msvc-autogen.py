...
libs = [
    'libunitedcontinentaldollar_cli',
    'libunitedcontinentaldollar_common',
    'libunitedcontinentaldollar_crypto',
    'libunitedcontinentaldollar_server',
    'libunitedcontinentaldollar_util',
    'libunitedcontinentaldollar_wallet_tool',
    'libunitedcontinentaldollar_wallet',
    'libunitedcontinentaldollar_zmq',
    'bench_unitedcontinentaldollar',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='UnitedContinentalDollar-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/unitedcontinentaldollar_config.h'), os.path.join(SOURCE_DIR, 'config/unitedcontinentaldollar-config.h'))
