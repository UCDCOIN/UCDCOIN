...
class NotificationsTest(UnitedContinentalDollarTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # https://github.com/unitedcontinentaldollar/unitedcontinentaldollar/pull/9371, it might be better
