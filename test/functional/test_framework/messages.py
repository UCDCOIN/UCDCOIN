...
"""UnitedContinentalDollar test framework primitive and message structures

CBlock, CTransaction, CBlockHeader, CTxIn, CTxOut, etc....:
    data structures that should map to corresponding structures in
    unitedcontinentaldollar/primitives
...
COIN = 100000000  # 1 ucd in satoshis
...
# Objects that map to unitedcontinentaldollard objects, which can be serialized/deserialized


class CAddress:
    __slots__ = ("net", "ip", "nServices", "port", "time")

    # see https://github.com/unitedcontinentaldollar/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in unitedcontinentaldollard
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in unitedcontinentaldollard indicates these should be deserialized as blocks
