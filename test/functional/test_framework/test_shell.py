...
class TestShell:
    """Wrapper Class for UnitedContinentalDollarTestFramework.

    The TestShell class extends the UnitedContinentalDollarTestFramework
    ...
    class __TestShell(UnitedContinentalDollarTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by UnitedContinentalDollarTestFramework child class.
            self.num_nodes = 1
