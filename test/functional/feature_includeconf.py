...
class IncludeConfTest(UnitedContinentalDollarTestFramework):
    ...
    def setup_chain(self):
        ...
        with open(os.path.join(self.options.tmpdir, "node0", "unitedcontinentaldollar.conf"), "a", encoding='utf8') as f:
