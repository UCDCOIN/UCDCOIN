...
# TestP2PConn: A peer we use to send messages to unitedcontinentaldollard, and store responses.
...
class CompactBlocksTest(UnitedContinentalDollarTestFramework):
    ...
    # This test actually causes unitedcontinentaldollard to (reasonably!) disconnect us, so do this last.
    ...
    # unitedcontinentaldollard's choice of nonce.
    ...
    # Test that unitedcontinentaldollard requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for unitedcontinentaldollard to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # unitedcontinentaldollard will not send blocktxn responses for blocks whose height is
