...
"""Test unitedcontinentaldollar-cli"""
...
# The block reward of coinbaseoutput.nValue (50) UCD/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 UCD/block.
BLOCKS = 101
...
class TestUnitedContinentalDollarCli(UnitedContinentalDollarTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `unitedcontinentaldollar-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and unitedcontinentaldollar-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 UCD) to the default wallet.
            ...
            # Test unitedcontinentaldollar-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test unitedcontinentaldollar-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestUnitedContinentalDollarCli().main()
