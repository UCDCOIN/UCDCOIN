...
Verify that a unitedcontinentaldollard node can maintain list of wallets loading on startup
"""
...
class WalletStartupTest(UnitedContinentalDollarTestFramework):
