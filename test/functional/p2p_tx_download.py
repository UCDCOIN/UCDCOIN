...
class TxDownloadTest(UnitedContinentalDollarTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new unitedcontinentaldollard instances, as setting mocktimes has long-term effects on when
