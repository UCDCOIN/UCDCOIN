...
class P2PPermissionsTests(UnitedContinentalDollarTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].unitedcontinentaldollarconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].unitedcontinentaldollarconf, 'w', encoding="utf8") as f:
            f.write(newText)
