...
By default, unitedcontinentaldollard will dump mempool on shutdown and
...
class MempoolPersistTest(UnitedContinentalDollarTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent unitedcontinentaldollard from writing mempool.dat to disk. Verify that `savemempool` fails")
