...
"""Verify that starting unitedcontinentaldollar with -h works as expected."""

from test_framework.test_framework import UnitedContinentalDollarTestFramework
from test_framework.util import assert_equal

class HelpTest(UnitedContinentalDollarTestFramework):
    ...
    def run_test(self):
        self.log.info("Start unitedcontinentaldollar with -h for help text")
        ...
        self.log.info("Start unitedcontinentaldollar with -version for version information")
        ...
        self.log.info("Start unitedcontinentaldollard with -fakearg to make sure it does not start")
