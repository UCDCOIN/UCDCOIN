...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/UnitedContinentalDollar
else
  DOCKER_EXEC echo \> \$HOME/.unitedcontinentaldollar
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/unitedcontinentaldollar/unitedcontinentaldollar/pull/18288#discussion_r433189350 for
  # details.
