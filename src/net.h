...
#ifndef UNITEDCONTINENTALDOLLAR_NET_H
#define UNITEDCONTINENTALDOLLAR_NET_H
...
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on UnitedContinentalDollar’s Peer-to-Peer Network")
...
#endif // UNITEDCONTINENTALDOLLAR_NET_H
