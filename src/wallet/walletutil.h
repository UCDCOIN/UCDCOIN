...
#ifndef UNITEDCONTINENTALDOLLAR_WALLET_WALLETUTIL_H
#define UNITEDCONTINENTALDOLLAR_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! unitedcontinentaldollar from opening the wallet, thinking it was newly created, and
...
#endif // UNITEDCONTINENTALDOLLAR_WALLET_WALLETUTIL_H
