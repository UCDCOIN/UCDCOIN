...
#ifndef UNITEDCONTINENTALDOLLAR_WALLET_WALLET_H
#define UNITEDCONTINENTALDOLLAR_WALLET_WALLET_H
...
public:
     ...
     * on this unitedcontinentaldollar node, and set to 0 for transactions that were created
...
#endif // UNITEDCONTINENTALDOLLAR_WALLET_WALLET_H
