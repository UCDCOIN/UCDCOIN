...
#ifndef UNITEDCONTINENTALDOLLAR_WALLET_COINSELECTION_H
#define UNITEDCONTINENTALDOLLAR_WALLET_COINSELECTION_H
...
#endif // UNITEDCONTINENTALDOLLAR_WALLET_COINSELECTION_H
