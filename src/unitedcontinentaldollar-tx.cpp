...
static void SetupUnitedContinentalDollarTxArgs(ArgsManager &argsman)
{
...
{
    SetupUnitedContinentalDollarTxArgs(gArgs);
    std::string error;
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " unitedcontinentaldollar-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  unitedcontinentaldollar-tx [options] <hex-tx> [commands]  Update hex-encoded unitedcontinentaldollar transaction\n" +
            "or:     unitedcontinentaldollar-tx [options] -create [commands]   Create hex-encoded unitedcontinentaldollar transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded unitedcontinentaldollar transaction
