...
#ifndef UNITEDCONTINENTALDOLLAR_RPC_RAWTRANSACTION_UTIL_H
#define UNITEDCONTINENTALDOLLAR_RPC_RAWTRANSACTION_UTIL_H
...
#endif // UNITEDCONTINENTALDOLLAR_RPC_RAWTRANSACTION_UTIL_H
