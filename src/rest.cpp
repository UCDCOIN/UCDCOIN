                       ...
                       const std::string& str_uri_part)
{
    ...
    int32_t blockheight = -1; // Initialization done only to prevent valgrind false positive, see https://github.com/unitedcontinentaldollar/unitedcontinentaldollar/pull/18785
