...
#ifndef UNITEDCONTINENTALDOLLAR_COMPAT_ASSUMPTIONS_H
#define UNITEDCONTINENTALDOLLAR_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "UnitedContinentalDollar cannot be compiled without assertions."
#endif
...
#endif // UNITEDCONTINENTALDOLLAR_COMPAT_ASSUMPTIONS_H
