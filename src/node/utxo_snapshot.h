...
#ifndef UNITEDCONTINENTALDOLLAR_NODE_UTXO_SNAPSHOT_H
#define UNITEDCONTINENTALDOLLAR_NODE_UTXO_SNAPSHOT_H
...
#endif // UNITEDCONTINENTALDOLLAR_NODE_UTXO_SNAPSHOT_H
