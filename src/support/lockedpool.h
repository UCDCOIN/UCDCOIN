...
#ifndef UNITEDCONTINENTALDOLLAR_SUPPORT_LOCKEDPOOL_H
#define UNITEDCONTINENTALDOLLAR_SUPPORT_LOCKEDPOOL_H
...
#endif // UNITEDCONTINENTALDOLLAR_SUPPORT_LOCKEDPOOL_H
