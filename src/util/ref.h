...
#ifndef UNITEDCONTINENTALDOLLAR_UTIL_REF_H
#define UNITEDCONTINENTALDOLLAR_UTIL_REF_H
 ...
 * (https://github.com/unitedcontinentaldollar/unitedcontinentaldollar/issues/16684)
 */
class Ref
{
public:
...
#endif // UNITEDCONTINENTALDOLLAR_UTIL_REF_H
