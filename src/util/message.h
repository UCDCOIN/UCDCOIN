...
#ifndef UNITEDCONTINENTALDOLLAR_UTIL_MESSAGE_H
#define UNITEDCONTINENTALDOLLAR_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's unitedcontinentaldollar address, it must refer to a public key.
...
#endif // UNITEDCONTINENTALDOLLAR_UTIL_MESSAGE_H
