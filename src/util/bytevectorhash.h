...
#ifndef UNITEDCONTINENTALDOLLAR_UTIL_BYTEVECTORHASH_H
#define UNITEDCONTINENTALDOLLAR_UTIL_BYTEVECTORHASH_H
...
#endif // UNITEDCONTINENTALDOLLAR_UTIL_BYTEVECTORHASH_H
