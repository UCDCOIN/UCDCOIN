...
{
    BOOST_CHECK(TestSplitHost("www.unitedcontinentaldollarcore.org", "www.unitedcontinentaldollarcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.unitedcontinentaldollarcore.org]", "www.unitedcontinentaldollarcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.unitedcontinentaldollarcore.org:80", "www.unitedcontinentaldollarcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.unitedcontinentaldollarcore.org]:80", "www.unitedcontinentaldollarcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:45798", "127.0.0.1", 45798));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:45798", "127.0.0.1", 45798));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:45798", "::ffff:127.0.0.1", 45798));
    BOOST_CHECK(TestSplitHost("[::]:45798", "::", 45798));
    BOOST_CHECK(TestSplitHost("::45798", "::45798", -1));
    BOOST_CHECK(TestSplitHost(":45798", "", 45798));
    BOOST_CHECK(TestSplitHost("[]:45798", "", 45798));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:45798", "127.0.0.1:45798"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:45798", "[::]:45798"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
