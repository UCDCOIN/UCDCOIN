...
#ifndef UNITEDCONTINENTALDOLLAR_TEST_UTIL_TRANSACTION_UTILS_H
#define UNITEDCONTINENTALDOLLAR_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // UNITEDCONTINENTALDOLLAR_TEST_UTIL_TRANSACTION_UTILS_H
