...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As UnitedContinentalDollar relies on 80 byte header hashes, we want to have an example for that.",
...
{
    /* test chacha20poly1305@unitedcontinentaldollar AEAD */
