...
#ifndef UNITEDCONTINENTALDOLLAR_TEST_SCRIPTNUM10_H
#define UNITEDCONTINENTALDOLLAR_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from UnitedContinentalDollar Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // UNITEDCONTINENTALDOLLAR_TEST_BIGNUM_H
