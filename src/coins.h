...
#ifndef UNITEDCONTINENTALDOLLAR_COINS_H
#define UNITEDCONTINENTALDOLLAR_COINS_H
 ...
 * between unitedcontinentaldollard, and unitedcontinentaldollar-qt and non-server tools.
 *
...
#endif // UNITEDCONTINENTALDOLLAR_COINS_H
