...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, UnitedContinentalDollarGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &UnitedContinentalDollarGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &UnitedContinentalDollarGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &UnitedContinentalDollarGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &UnitedContinentalDollarGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &UnitedContinentalDollarGUI::updateWalletStatus);
    connect(gui, &UnitedContinentalDollarGUI::setPrivacy, walletView, &WalletView::setPrivacy);
