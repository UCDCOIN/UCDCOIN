    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return UnitedContinentalDollarUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, UnitedContinentalDollarUnits::SeparatorStyle::NEVER);
            else
                return UnitedContinentalDollarUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+UnitedContinentalDollarUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
