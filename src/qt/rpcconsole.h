...
#ifndef UNITEDCONTINENTALDOLLAR_QT_RPCCONSOLE_H
#define UNITEDCONTINENTALDOLLAR_QT_RPCCONSOLE_H
...
/** Local UnitedContinentalDollar RPC console. */
...
#endif // UNITEDCONTINENTALDOLLAR_QT_RPCCONSOLE_H
