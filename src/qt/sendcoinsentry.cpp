    ...
    platformStyle(_platformStyle)
{
    ...
    // normal unitedcontinentaldollar address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying unitedcontinentaldollar address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &UnitedContinentalDollarAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
