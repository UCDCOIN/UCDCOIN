    ...
    mapper(nullptr)
{
    ...
    ui->unitedcontinentaldollarAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->unitedcontinentaldollarAtStartup);
    ...
    ui->unitedcontinentaldollarAtStartup->setToolTip(ui->unitedcontinentaldollarAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->unitedcontinentaldollarAtStartup->setText(ui->unitedcontinentaldollarAtStartup->text().arg(PACKAGE_NAME));

    ui->openUnitedContinentalDollarConfButton->setToolTip(ui->openUnitedContinentalDollarConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new UnitedContinentalDollarUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->unitedcontinentaldollarAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openUnitedContinentalDollarConfButton_clicked()
{
    ...
    if (!GUIUtil::openUnitedContinentalDollarConf())
