...
#ifndef UNITEDCONTINENTALDOLLAR_QT_SENDCOINSDIALOG_H
#define UNITEDCONTINENTALDOLLAR_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending unitedcontinentaldollars */
...
#endif // UNITEDCONTINENTALDOLLAR_QT_SENDCOINSDIALOG_H
