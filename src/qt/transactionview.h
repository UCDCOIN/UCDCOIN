...
#ifndef UNITEDCONTINENTALDOLLAR_QT_TRANSACTIONVIEW_H
#define UNITEDCONTINENTALDOLLAR_QT_TRANSACTIONVIEW_H
...
#endif // UNITEDCONTINENTALDOLLAR_QT_TRANSACTIONVIEW_H
