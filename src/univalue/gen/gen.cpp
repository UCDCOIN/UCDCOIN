...
static void outputEscape()
{
	printf(	"// Automatically generated file. Do not modify.\n"
		"#ifndef UNITEDCONTINENTALDOLLAR_UNIVALUE_UNIVALUE_ESCAPES_H\n"
		"#define UNITEDCONTINENTALDOLLAR_UNIVALUE_UNIVALUE_ESCAPES_H\n"
	...
	printf(	"};\n"
		"#endif // UNITEDCONTINENTALDOLLAR_UNIVALUE_UNIVALUE_ESCAPES_H\n");
}
