...
#ifndef UNITEDCONTINENTALDOLLAR_SCRIPT_SIGNINGPROVIDER_H
#define UNITEDCONTINENTALDOLLAR_SCRIPT_SIGNINGPROVIDER_H
...
#endif // UNITEDCONTINENTALDOLLAR_SCRIPT_SIGNINGPROVIDER_H
