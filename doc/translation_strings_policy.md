...
This document provides guidelines for internationalization of the UnitedContinentalDollar Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `unitedcontinentaldollar_en.ts` remains unchanged.
