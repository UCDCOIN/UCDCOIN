...
```sh
make src/unitedcontinentaldollard src/unitedcontinentaldollar-cli
make src/qt/unitedcontinentaldollar-qt
...
[remote "upstream-pull"]
        ...
        url = git@github.com:unitedcontinentaldollar/unitedcontinentaldollar.git
```
