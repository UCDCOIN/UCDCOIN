...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the unitedcontinentaldollar repository."
  exit 1
fi
...
# See https://github.com/unitedcontinentaldollar/unitedcontinentaldollar/issues/16064
...
echo 'When compiling unitedcontinentaldollard, run `./configure` in the following way:'
echo
