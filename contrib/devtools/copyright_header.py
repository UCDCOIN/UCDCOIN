...
EXCLUDE = [
    # auto generated:
    'src/qt/unitedcontinentaldollarstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The UnitedContinentalDollar Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a unitedcontinentaldollar source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The UnitedContinentalDollar Core developers'
...
Arguments:
    <file> - A source file in the unitedcontinentaldollar repository.
"""
