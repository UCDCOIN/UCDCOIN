# Bootstrappable UnitedContinentalDollar Core Builds

This directory contains the files necessary to perform bootstrappable UnitedContinentalDollar
Core builds.
...
- 24GB of free disk space on the partition that the UnitedContinentalDollar Core git repository
  resides in
...
For a UnitedContinentalDollar Core depends development environment, simply invoke
...
From the top of a clean UnitedContinentalDollar Core repository:
...
To use dongcarl's substitute server for UnitedContinentalDollar Core builds after having
